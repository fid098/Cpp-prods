...
int main()
{
    ...
    // Done: show that stack address and heap address are far apart in virtual space
    std::cout << "The stack address is: " << static_cast<void *>(stack_buf.data()) << "\n";
    std::cout << "The heap address is: " << static_cast<void *>(heap_buf) << "\n";
